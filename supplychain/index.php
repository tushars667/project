...
<html lang="en">
  ...
  <center>
    ...
    <div style="width: 100%">
      ...
      <source src="SupplyChainDAPP\vecteezy_delivery-service-4k-animation-delivery-man-riding-a-scooter_7118562.mp4" type="video/mp4">
  
     </video>
    
      <div class="loginformcard" id="card1">
            <h4> Welcome to Holistic supply chain</h4>
